...
const SHAPES = [
  { size: 450, x: '8%',  y: '12%', color: 'rgba(56,189,248,0.28)',   driftDur: 30, xAmp: 25, yAmp: 18, pFactor: 0.012 },  /* sky blue */
  { size: 360, x: '76%', y: '8%',  color: 'rgba(251,146,60,0.22)',   driftDur: 36, xAmp: 20, yAmp: 30, pFactor: 0.018 },  /* warm orange */
  { size: 320, x: '60%', y: '62%', color: 'rgba(167,139,250,0.25)',  driftDur: 34, xAmp: 30, yAmp: 22, pFactor: 0.010 },  /* lavender */
  { size: 260, x: '15%', y: '68%', color: 'rgba(52,211,153,0.22)',   driftDur: 28, xAmp: 18, yAmp: 25, pFactor: 0.022 },  /* mint */
  { size: 220, x: '86%', y: '40%', color: 'rgba(251,113,133,0.20)',  driftDur: 32, xAmp: 14, yAmp: 18, pFactor: 0.015 },  /* rose */
  { size: 380, x: '40%', y: '28%', color: 'rgba(56,189,248,0.18)',   driftDur: 38, xAmp: 22, yAmp: 16, pFactor: 0.008 },  /* light cyan */
]
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        left: -150,
        top: -150,
        background: 'radial-gradient(circle, rgba(251,146,60,0.30) 0%, rgba(251,113,133,0.15) 40%, transparent 70%)',
        filter: 'blur(30px)',
        willChange: 'transform',
        zIndex: 1,
      }}
